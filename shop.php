...
<body>
  ...
  <div class="grid-container">
    ...
    ?>
        <div class="grid-item">
          <div class="image">
            <img src="images/<?= $row['img_url']; ?>" class="food_img">
          </div>
          <div class="name_recipe">
            <b style="color : black"><?php echo $row["name"]; ?></b><br>
            <small style="color : black"><?php echo $row["description"]; ?></small><br>
            <b style="color : black"><?php echo "Price: $", $row["price"]; ?></b><br>
